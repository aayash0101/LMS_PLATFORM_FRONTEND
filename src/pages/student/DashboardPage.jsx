...
const StudentDashboardPage = () => {
    ...
    const recentEnrollments = Array.isArray(dashboard?.recentEnrollments)
        ? dashboard.recentEnrollments
        : []

    const totalCourses = dashboard?.totalEnrolled ?? 0
    const completedCourses = dashboard?.completed ?? 0
        ...
        <div className="space-y-8">
            ...
            <div className="space-y-4">
                <div className="flex items-center justify-between">
                    ...
                    <LinkButton variant="ghost" size="sm" to="/my-courses">
                        View all
                    </LinkButton>
                </div>
                                ...
                                <Card key={enrollment._id} className="hover:shadow-md transition-shadow">
                                    <CardContent className="p-4">
                                        <div className="flex items-center gap-4">
                                            ...
                                            {/* Action — LinkButton with to prop, no nested Link */}
                                            <LinkButton
                                                size="sm"
                                                variant="outline"
                                                className="shrink-0"
